...
graph TB
    subgraph "Frontend"
        IC[Interface Clinique<br/>React + TailwindCSS<br/>:3000]
    end
    ...
    subgraph "Microservices Backend"
        DI[DocIngestor<br/>:8001]
        DD[DeID<br/>:8002]
        IDX[Indexeur<br/>:8003]
        LLM[LLMQA<br/>:8004]
        SYN[Synthèse<br/>:8005]
        AUD[AuditLogger<br/>:8006]
    end
